                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="table-action-buttons">
                                            <a class="view button button-box button-xs button-primary" href="{{ route('orders.detail', $order->id) }}"><i class="zmdi zmdi-more"></i></a>
                                            @if (!in_array($order->status, [3, 4]))
                                                <a class="edit button button-box button-xs button-info" href="{{ route('orders.edit', $order->id) }}"><i class="zmdi zmdi-edit"></i></a>
                                            @endif
                                        </div>
                                    </td>
                                </tr>
